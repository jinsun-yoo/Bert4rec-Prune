...
class BERTModel(BaseModel):
    ...
    def set_masks(self, masks):
        ...
        #print('[5]')
        self.bert.transformer_blocks[1].attention.linear_layers[0].set_masks((masks[8]))
        #print('[6]')
        self.bert.transformer_blocks[1].attention.linear_layers[1].set_masks((masks[9]))
        #print('[7]')
        self.bert.transformer_blocks[1].attention.linear_layers[2].set_masks((masks[10]))
        #print('[8]')
        self.bert.transformer_blocks[1].attention.output_linear.set_masks((masks[11]))
