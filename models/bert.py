...
class BERTModel(BaseModel):
    ...
    def set_masks(self, masks):
        ...
        self.bert.transformer_blocks[0].attention.linear_layers[1].set_masks((masks[4]))
        self.bert.transformer_blocks[0].attention.linear_layers[2].set_masks((masks[6]))
        self.bert.transformer_blocks[0].attention.output_linear.set_masks((masks[8]))
        ...
        self.bert.transformer_blocks[0].attention.linear_layers[0].set_masks((masks[18]))
        self.bert.transformer_blocks[0].attention.linear_layers[1].set_masks((masks[20]))
        self.bert.transformer_blocks[0].attention.linear_layers[2].set_masks((masks[22]))
        self.bert.transformer_blocks[0].attention.output_linear.set_masks((masks[24]))
