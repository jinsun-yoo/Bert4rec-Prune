def set_template(args):
    if args.template is None:
    ...
    elif args.template.startswith('proofofconcept_prune'):
        args.mode = 'train'
    ...
    elif args.template.startswith('embedsplit_smallweight_poc'):
        args.mode = 'train'
    ...
    elif args.template.startswith('embedsplit_smallweight_prune'):
        args.mode = 'train'
    ...
    elif args.template.startswith('smallweight_all_poc'):
        args.mode = 'train'
        ...
        args.prune_code = 'smallweight_all'
        args.pruning_perc = 10
        args.pruning_perc_embed = 10
    ...
    elif args.template.startswith('smallweight_prune'):
        args.mode = 'train'
